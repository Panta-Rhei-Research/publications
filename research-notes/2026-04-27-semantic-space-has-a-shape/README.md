...
- PDF: `research-note-2026-04-27-semantic-space-has-a-shape.pdf`
...
Core claim: Semantic-space regularities in the anchor paper give a serious calibration surface for Book VII's claim that public language is a structured readout of subsymbolic pattern organization.
