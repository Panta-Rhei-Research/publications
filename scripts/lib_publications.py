...
PUBLICATION_REGISTRY: dict[str, dict[str, Any]] = {
    ...
    "wp002-t-theory-executive-synopsis": {
        ...
        "license": "CC-BY-4.0",
        "related_lanes": ["publications", "corpus", "verify"],
        "related_routes": ["/publications/anchor-documents/wp002-t-theory-executive-synopsis/"],
    },
    "wp003-taulib-technical-overview": {
        ...
        "license": "CC-BY-4.0",
        "related_lanes": ["publications", "corpus", "verify"],
        "related_routes": ["/publications/anchor-documents/wp003-taulib-technical-overview/"],
    },
    "wp004-public-research-observatory-blueprint": {
        ...
        "license": "CC-BY-4.0",
        "related_lanes": ["publications", "engage", "verify"],
        "related_routes": ["/publications/anchor-documents/wp004-public-research-observatory-blueprint/"],
    },
    "wp005-global-public-good-impact-overview": {
        ...
        "license": "CC-BY-4.0",
        "related_lanes": ["publications", "impact", "verify"],
        "related_routes": ["/publications/anchor-documents/wp005-global-public-good-impact-overview/"],
    },
